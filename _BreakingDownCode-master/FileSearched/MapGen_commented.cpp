...
/*#############################################################|
  # Function name: 	GenerateWorldMap()
  # Input:		fill in later
  # Output:		fill in later
  # Description of ():	
  #	GenerateWorldMap
